...
cprequire_test(["inline:net-mydomain-widget-currsens"], function(myWidget) {
...
cpdefine("inline:net-mydomain-widget-currsens", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "net-mydomain-widget-currsens", // Make the id the same as the cpdefine id
        name: "Widget / CurrSens", // The descriptive name of your widget.
        desc: "Description description", // A description of what your widget does
