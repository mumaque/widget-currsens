# net-mydomain-widget-currsens
Description description

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Widget / CurrSens
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | net-mydomain-widget-currsens |
| Name                  | Widget / CurrSens |
| Description           | Description description |
| chilipeppr.load() URL | http://raw.githubusercontent.com/mumaque/widget-currsens/master/auto-generated-widget.html |
| Edit URL              | http://ide.c9.io/mumaque/widget-currsens |
| Github URL            | http://github.com/mumaque/widget-currsens |
| Test URL              | https://preview.c9users.io/mumaque/widget-currsens/widget.html |
...
$("body").append('<' + 'div id="myDivNetMydomainWidgetCurrsens"><' + '/div>');

chilipeppr.load(
  "#myDivNetMydomainWidgetCurrsens",
...
The table below shows, in order, the methods and properties inside the widget/element.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"net-mydomain-widget-currsens"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Widget / CurrSens"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"Description description"</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/mumaque/widget-currsens/master/auto-generated-widget.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/mumaque/widget-currsens"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/mumaque/widget-currsens"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://widget-currsens-mumaque.c9users.io/widget.html"</td></tr><tr valign="top"><td>publish</td><td>object</td><td>Please see docs above.<br><br>Define the publish signals that this widget/element owns or defines so that
